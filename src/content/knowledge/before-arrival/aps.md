---
{
  ...
  "officialSources": [
    ...
    {
      "label": "APS China — 留学比利时",
      "url": "https://www.aps.org.cn/zh/bel"
    }
  ],
  "related": [
...
**2026-09-14 更新：** APS 并非所有赴比利时学生统一适用。KU Leuven 列有完全豁免及仅免面谈情形，例如 CSC 资助学生属于完全豁免范围之一。请先按本人国籍、既往学习经历和录取身份向学校确认。
...
**2026-09-14 更新：** 申请比利时荷语区的 APS 面谈，审核部现行页面写明使用英语；不要直接套用留德审核的语言选择。请按所选比利时程序的通知准备。
