...
{
  "key": "transport/taxis",
  "titleZh": "出租车：在哪里找车与费用参考",
  "titleEn": "Finding a taxi in Leuven",
  "descriptionZh": "火车站、大广场附近候客点、电话预约及 2024 费用记录。",
  "descriptionEn": "Taxi locations, booking suggestions and historical local fare ranges.",
  "category": "transport",
  "order": 14,
  "aliases": [
    "出租车",
...
以上是将手册“电话或官网叫车／预订”和“费用及付款”信息整理成核对点，未承诺即时车源。
