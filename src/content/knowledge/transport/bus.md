...
{
  "key": "transport/bus",
  "titleZh": "公交：De Lijn 与学生公交卡",
  "titleEn": "De Lijn buses and the Student Bus Pass",
  "descriptionZh": "学生公交卡范围、MOBIB、历史票价和乘车、按铃、改道提醒。",
  "descriptionEn": "Student Bus Pass information, historical De Lijn fares and practical boarding guidance.",
  "category": "transport",
  "order": 12,
  "aliases": [
    "公交",
  ...
  "sourceSection": "公共交通／购票／关于有效期／注意事项",
  "sourcePages": [
    26,
    27,
    28
  ...
  "officialSources": [
    {
      "label": "De Lijn Student Bus Pass",
      "url": "https://www.delijn.be/en/content/bijdrage-school/studentenbuspas-leuven/"
    },
    {
      "label": "De Lijn 官网",
...
- 通常前门上、后门下；拥挤等特殊情况可能不同，遵循现场安排。
- 车辆不会每站都停，接近目的站时按 **HALTE** 停车铃；原文形容为扶手上的蓝色按钮。
- 部分车辆靠站后需乘客按开门按钮。
- 给从后门上车的轮椅、婴儿车乘客让出相应空间。
- 手册称当时多数车辆没有报站，陌生路线应留意位置；不要依赖此历史描述判断现在车辆设备。

## 改道、罢工与不同日期的班次

手册提及 Grote Markt 周边、Naamsestraat 与 Bondgenotenlaan 一带，可能因活动、周五集市或施工出现较大改道。原文关于集市地点与线路的概括尚未核实。

De Lijn 官方网站、应用、站牌及媒体会发布变化。原文提醒第三方导航可能没显示改道，并提及关注当时的 Twitter 渠道；关键是出发前核对运营商公告。

工作日、周末、寒暑假及法定假日可能使用不同时刻表；亦应留意偶发罢工和新闻。本站不从 2024 资料推算当前时刻。
