---
{
  "key": "healthcare/student-health",
  "titleZh": "学生健康服务、检查与心理支持",
  "titleEn": "Student health and mental well-being",
  "descriptionZh": "校医、检查预约、心理支持，以及手册中的中医和疫苗历史信息。",
  "descriptionEn": "Student GPs, examinations and mental-health support, with clearly dated handbook notes.",
  "category": "healthcare",
  "order": 20,
  "aliases": [
  ...
  "sourceChapter": "第八章 比利时及鲁汶医疗",
  "sourceSection": "看病：普通病症；体检；心理问题；中医药问诊；疫苗注射",
  "sourcePages": [
    33
  ],
  "sourceYear": 2024,
  ...
  "officialSources": [
    {
      "label": "KU Leuven 学生健康服务",
      "url": "https://www.kuleuven.be/english/stuvo/health"
    },
    {
      "label": "KU Leuven 心理健康",
      "url": "https://www.kuleuven.be/english/stuvo/health/mental-health"
    },
    {
      "label": "MCH 医疗中心",
...
手册描述，比利时针对年轻学生、在职人员没有与国内相同的定期系统体检习惯。想了解某项检查时，可先向 GP 说明自己的不适或检查原因，由医生讨论需要的检查和合适的去处。

手册以超声检查举例，写到 GP 可以推荐检查诊所，再由本人电话预约。它给出的等待时间经验为：不急时医院可能约 **两个月**，其他医疗中心如 **MCH** 可能约 **一周**。这些只是 **2024 年手册经验值**，并非预约承诺，也不能据此判断病情紧急程度。

医疗中心入口：[MCH](https://www.mchinfo.be/)。检查项目、转诊、可预约时间和费用应向 GP 或医疗中心核实。
...
手册介绍比利时存在提供把脉、针灸、推拿、拔罐和中药相关服务的诊所，并提供比利时中医药联合会地址：[手册所载网站](http://belgiumzhongguoyiyao.bftcm.be/)。

这是对原手册目录信息的保留，未核实机构现况、人员资质或治疗效果，也不构成治疗建议。
