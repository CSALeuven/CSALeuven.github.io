...
{
  "key": "study/honours",
  "titleZh": "学位荣誉等级：历史阈值与核实事项",
  "titleEn": "Degree honours: historical thresholds to verify",
  "descriptionZh": "保留手册的 Latin honours 标签、百分比和 PhD 门槛说法，同时说明边界与适用范围未核实。",
  "descriptionEn": "The original Latin honours labels, percentages and PhD statement, with unverified boundaries and applicability.",
  "category": "study",
  "order": 180,
  "aliases": [
    "评优",
  ...
  "sourceChapter": "第五章 在鲁汶学习",
  "sourceSection": "第五章 第 2 节：评优标准",
  "sourcePages": [
    17
  ],
  "sourceYear": 2024,
...
### summa cum laude with the congratulation of the examination committee
...
**本页用于追溯 2024 手册，不应作为评优计算器或博士申请资格结论。**待查得当前项目规定后，可更新审核状态并附来源。
