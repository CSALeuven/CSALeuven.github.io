export const site = {
  shortName: 'CSAL',
  name: { zh: '鲁汶中国学生学者联合会', en: 'Chinese Students and Scholars Association Leuven' },
  ...
  // Provisional wording for committee review. Do not invent an email or founding date.
};
