...
- **Social links / email:** edit `src/data/site.ts` only. The confirmed official email is stored in `site.email` and reused by the Contact page, Stay Connected links and footer. URLs must not be repeated in UI components.
